#!/bin/zsh
#
# Setup script for macOS React Native development
...
main() {
    ...
    echo -e "${cyan}3. node, watchman${plain}"
    echo -e "${cyan}4. rbenv, ruby@3.3.0, cocoapods${plain}"
    ...
    echo -e "${cyan}8. React Native CLI${plain}"
    echo -e "${divider}"
...
echo -e "${magenta}macOS React Native enviroment setup script - ZL Asica${plain}"
echo -e "https://github.com/ZL-Asica/server-setup-scripts/blob/main/mac_react-native.sh"
